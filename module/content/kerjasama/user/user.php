...
?>
	...
	<div class='card card-success'>
		<div class='card-body'>
			<select onchange="window.document.location.href=this.options[this.selectedIndex].value;" class='select2bs4 select2-primary form-control' name='ta'>
		...
		if($p['value']==$folder['3']) { $selected = 'selected'; } else {$selected = '';}
			echo "
				<option value='/select2bs4 select2-primary/jenis/$p[value]' $selected>$p[desc]</option>
			";
		}
		?>
