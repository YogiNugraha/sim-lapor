...
declare(strict_types=1);
	...
	$qp = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='ins' AND value='$folder[3]' ");
		...
		<div class="card-body">
			<div class='table-responsive'>
				<table class='table table-striped' id='custom'>
					...
					<tbody class='text-sm'>
<?php
	$qsk = mysqli_query($con,"SELECT * FROM ins WHERE id_jenis='$folder[3]' AND asal='$_SESSION[ses_user]' ORDER BY date DESC ");
...
?>
					<tr>
						...
						<td><a href='/ins/edit/<?php echo $sk['id']; ?>'><i class='fa fa-users'></i> Lihat</a></td>
						<td>
							<a href='#' data-toggle='dropdown'><i class='fa fa-ellipsis-v'></i></a>
							<div class='dropdown-menu text-xs'>
								<a class='dropdown-item' href='/ins/edit/<?php echo $sk['id']; ?>'>Edit</a>
								<a class='dropdown-item' href='/delete/ins/<?php echo $sk['id']; ?>/<?php echo $folder['3']; ?>'>Hapus</a>
							</div>
						</td>					
					</tr>
<?php
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" enctype="multipart/form-data" method="post" action="/insert/ins">
