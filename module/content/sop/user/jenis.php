...
declare(strict_types=1);
	...
	$qp = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='sop' AND value='$folder[3]' ");
		...
		<div class='card-header with-border'>
			<h3 class='card-title'><?php echo $p['desc']; ?></h3>
		                <div class="card-tools">
		                      <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#tambah"><i class="fas fa-plus"></i> Tambah SOP</button>
		                 </div>	
		</div>
		<div class="card-body">
			<div class='table-responsive'>
				<table class='table table-striped'>
					...
					<tr>
						...
						<td>-</td>
						<td>-</td>
						<td><a href='/file/sop/<?php echo $_SESSION['ses_user']; ?>.rar' target='_blank'><i class='fa fa-file-pdf'></i> File</a></td>
						<td>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" enctype="multipart/form-data" method="post" action="/insert/sk">
